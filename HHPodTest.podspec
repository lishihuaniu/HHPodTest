...
Pod::Spec.new do |s|
    ...
    s.homepage         = 'https://github.com/izhikang/HHPodTest'
    # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
    s.license          = { :type => 'MIT', :file => 'LICENSE' }
    s.author           = { 'izhikang' => 'lishihua@tal.com' }
    s.source           = { :git => 'https://github.com/izhikang/HHPodTest.git', :tag => s.version.to_s }
